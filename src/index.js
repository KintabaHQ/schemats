...
function typescriptOfSchema(db, tables, schema, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var optionsObject, enumObject, enumTypes, compositeTypes, interfacePromises, interfaces, output, formatterOption, processedResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (typeof db === "string") {
                ...
                case 3:
                    enumObject = _a.sent();
                    enumTypes = typescript_1.generateEnumType(enumObject, optionsObject);
                    return [4 /*yield*/, typescript_1.generateCompositeType(db, optionsObject, lodash_1.keys(enumObject))];
                case 4:
                    compositeTypes = _a.sent();
                    interfacePromises = tables.map(function (table) {
                        return typescriptOfTable(db, table, schema, optionsObject);
                    });
                    return [4 /*yield*/, Promise.all(interfacePromises).then(function (tsOfTable) {
                            return tsOfTable.join("");
                        })];
                case 5:
                    interfaces = _a.sent();
