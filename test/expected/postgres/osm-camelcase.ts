...
export namespace UsersFields {
  ...
  export type boolArrayCol = boolean[] | null;
  export type varcharArrayCol = string[] | null;
  export type int2ArrayCol = number[] | null;
  export type int4ArrayCol = number[] | null;
  export type int8ArrayCol = number[] | null;
  export type uuidArrayCol = string[] | null;
  export type textArrayCol = string[] | null;
  export type byteaArrayCol = string[] | null;
  ...
  export type jsonArrayCol = Object[] | null;
  export type jsonbArrayCol = Object[] | null;
  export type timestamptzArrayCol = Date[] | null;
}
