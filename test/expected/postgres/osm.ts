...
export type format_composite = {
    second_value: string | null;
    first_value: string | null;
    third_value: format_enum | null;
};
...
export namespace usersFields {
    ...
    export type home_lat = string | null;
    export type home_lon = string | null;
    ...
    export type money_col = string | null;
    ...
    export type double_col = string | null;
    ...
    export type composite_col = format_composite | null;
...
export interface users {
    ...
    composite_col: usersFields.composite_col;
