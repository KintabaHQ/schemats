...
export namespace usersFields {
  ...
  export type bool_array_col = boolean[] | null;
  export type varchar_array_col = string[] | null;
  export type int2_array_col = number[] | null;
  export type int4_array_col = number[] | null;
  export type int8_array_col = number[] | null;
  export type uuid_array_col = string[] | null;
  export type text_array_col = string[] | null;
  export type bytea_array_col = string[] | null;
  ...
  export type json_array_col = Object[] | null;
  export type jsonb_array_col = Object[] | null;
  export type timestamptz_array_col = Date[] | null;
}
